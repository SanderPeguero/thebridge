                ...
                <div className="max-w-md mx-auto my-10">
                    ...
                    <div className="m-7">
                        <form >
                            ...
                            <p className="text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a to='/signin' className="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign up</a>.</p>
                        </form>
                    </div>
                </div>
            </div>
